@rem ---------------------------------------------------------------------------
@rem Script used to build the DelphiDabbler Version Information Spy File Reader
@rem DLL
@rem
...
echo DelphiDabbler VIS Reader DLL Build Script
echo -----------------------------------------
