 ...
 * UReporter.pas
 * 
 * Defines abstract base class for objects that implement the IVerInfoReporter3
...
type
  ...
  {
  TReporter:
    Abstract base class for reporter objects that implement IVerInfoReporter3.
