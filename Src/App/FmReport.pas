{ ##
  @FILE                     FmReport.pas
  @COMMENTS                 Defines abstract base class for all dialog boxes
                            that display version information reports in
                            different formats generated by FVReport.dll.
                            Provides core functionality and loads / unloads the
                            DLL.
  ...
  @HISTORY(
    ...
    @REVISION(
      ...
      @COMMENTS             Major update:
                            + Redesigned as a base class for specialist dialog
                              boxes that display different kinds of version
                              information reports generated by FVReport.dll
                              rather than providing a dialog box that directly
                              displays different reports as text.
                            + Now derived from TGenericViewDlg rather than TForm
                              to enable access to help and alignment
                              functionality.
    )
  )
}
