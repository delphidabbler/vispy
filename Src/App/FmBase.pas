{ ##
  @FILE                     FmBase.pas
  @COMMENTS                 Implements a form that provides the ancestor for all
                            forms in the application. Provides default names for
                            form window classes along with some routines that
                            display a basic, aligned, pop-up dialog box.
